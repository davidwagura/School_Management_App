...
@section('content') 
    ...
    <div class="create-inputs  justify-center items-center pt-6 flex flex-wrap container bg-orange-200">
        <form action="{{ route('student.store') }}" method="post">
            ...
            @method('post')
                ...
                <div class="flex row mt-4">
                    ...
                    <select class="flex w-full h-8 bg-white border ml-9 rounded" id="gender" name="gender">
                ...
                <div class="flex row mt-4">
                    <label class="justify-around" for="admission_number">Admission Number:</label>
                ...
                <div class="flex row mt-4">
                    ...
                    <select class="flex w-full h-8 bg-white border ml-9" id="county" name="home_county">

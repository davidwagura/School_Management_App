    ...
    <table class="table-auto min-w-full text-center grid grid-cols-auto place-content-center ...">
        ...
        @foreach ($teachers as $teacher)
            <tr class="px-4 py-3">
                ...
                <td class="text-white">
                    <div>
                        <button class="bg-red-500 hover:bg-red-300 h-8 ml-6 px-4 mt-2 rounded pr-4">
                ...
                <td class="text-white">
                    <div>
                        <button class="bg-blue-500 hover:bg-blue-700 ml-7 h-8 px-4 mt-2 pl-5 rounded pr-4">
